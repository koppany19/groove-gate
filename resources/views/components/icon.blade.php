...
@php
    $isFill = in_array($name, ['info', 'google', 'facebook']);
@endphp
...
<svg
    ...
    @if(!$isFill) stroke="{{ $stroke }}" stroke-width="{{ $strokeWidth }}" @endif
    class="{{ $class }}"
>
    @switch($name)
        ...
        @case('chat')
            <path d="M12 21l-4-4H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-3l-4 4z"/>
        @break
